...
struct sysent sysent[] = {
	...
	{ AS(timer_create_args), (sy_call_t *)sys_timer_create },	/* 235 = timer_create */
	{ AS(timer_delete_args), (sy_call_t *)sys_timer_delete },	/* 236 = timer_delete */
	{ AS(timer_settime_args), (sy_call_t *)sys_timer_settime },	/* 237 = timer_settime */
	{ AS(timer_gettime_args), (sy_call_t *)sys_timer_gettime },	/* 238 = timer_gettime */
	{ AS(timer_getoverrun_args), (sy_call_t *)sys_timer_getoverrun },	/* 239 = timer_getoverrun */
